...
<body class="clean-body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #FFFFFF">
  ...
  <table class="nl-container" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #FFFFFF;width: 100%" cellpadding="0" cellspacing="0">
      ...
      <div style="font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%;color:#ffffff; padding-right: 0px; padding-left: 0px; padding-top: 30px; padding-bottom: 30px;">
      	<div style="font-size:12px;line-height:14px;color:#ffffff;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center"><strong><span style="font-size: 28px; line-height: 33px;">UniBook</span></strong></p></div>
      </div>
      <div align="center" class="img-container center  autowidth " style="padding-right: 0px;  padding-left: 0px;">
          <a href="g9.deltaschool.it" target="_blank">
          <img class="center  autowidth " align="center" border="0" src="https://icon-icons.com/icons2/588/PNG/512/1458264596_authorisation_lock_padlock_safe_password_privacy_security_icon-icons.com_55333.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;width: 100%;max-width: 402px" width="402">
        </a>
      </div>
      </div>
      </div>
      ...
      <div style="font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%;color:#ffffff; padding-right: 10px; padding-left: 10px; padding-top: 25px; padding-bottom: 10px;">
      	<div style="font-size:18px;line-height:22px;text-align:center;color:#ffffff;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;"><p style="margin: 0;font-size: 18px;line-height: 22px;text-align: center"><span style="font-size: 24px; line-height: 28px;"><strong>Email di reset password</strong></span></p></div>
      </div>
      <div style="font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%;color:#B8B8C0; padding-right: 10px; padding-left: 10px; padding-top: 0px; padding-bottom: 10px;">
          ...
          <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">
            <span style="font-size: 14px; line-height: 21px;">
              Ciao! Hai ricevuto questa email perchè hai dimenticato la tua password. Purtroppo per ragioni di sicurezza neppure noi conosciamo la tua password, per cui te ne abbiamo inviata una temporanea con cui potrai accedere al nostro sito.
            </span>
          </p>
        </div>
        <div style="font-size:14px;line-height:21px;text-align:center;color:#B8B8C0;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;">
          <p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">
            <br>
            <span style="font-size: 14px; line-height: 21px;">
              Ecco la tua nuova password: <strong>{{$newPassword}}</strong>
            </span>
          </p>
        </div>
      </div>
