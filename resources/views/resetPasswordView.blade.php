  ...
  <div class="wrapper">
    <div class="login">
      ...
      <div id="container">
        <div class="row">
          <div class="col-md-12">
            <p style="text-align:justify">Sei stato reindirizzato a questa pagina perchè hai richiesto il reset della password. Prima di continuare a navigare su UniBook devi impostarne una nuova.</p>
          </div>
        </div>
        <br />
        <br />
        <form method="POST" action="/register/resetPassword/{{$id_user}}">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="lg-btn">
                <button type="submit" class="button">Cambia email</button>
              </div>
            </div>
          </div>
