                    ...
                    @if($alreadyFollow)
                        <p id="stopFollowP" style="text-align: center; color: red;">
                            <a style="cursor: pointer; font-size: 20px;"
                               onclick="stopFollow({{$page->id_page}}, '{{$logged_user->id_user}}')">
                                <i style="cursor:pointer; color: red;" id="follow"
                                   class="glyphicon glyphicon-thumbs-down"></i>&nbsp;Smetti di seguire la pagina</a>
                        </p>
                    @else
                        <p id="followP" style="text-align: center; color: blue;">
                            <a style="cursor: pointer; font-size: 20px;"
                               onclick="follow({{$page->id_page}}, '{{$logged_user->id_user}}')">
                                <i style="cursor:pointer; color: blue;" id="follow"
                                   class="glyphicon glyphicon-thumbs-up"></i>&nbsp;Segui</a>
                        </p>
                    @endif
                    <br/>
                    <div id="totFollowers">
                        <p style="text-align: center; color: blue; font-size: 20px;">
                            <i style="color: blue;" id="like"
                               class="glyphicon glyphicon-user"></i>&nbsp;{{$tot_followers}}&nbsp;persone seguono questa
                            pagina</p>
                    </div>
                </div>
                ...
                <hr> @if($logged_user->id_user == $page->id_user)
                    ...
                    <div style="text-align: center;">
                        <button type="button" class="btn btn-primary" style="display: block; margin: 0 auto;"
                                onclick="InvitaAmici({{$page->id_page}});">Invita
                        </button>
                        <br/>
                                ...
                                <section class="post-footer">
                                    ...
                                    <div class="post-footer-option container">
                                        <ul id="option_" class="list-unstyled">
                                            ...
                                            <li>
                                                <a>
                                                    <i onclick="reaction(this.id)" style="cursor:pointer;" id="dislike"
                                                       class="glyphicon glyphicon-thumbs-down"></i>
                                                </a>
                                            </li>
                                            <li>
                                                <a>
                                                    <i onclick="commentfocus(this.id)" style="cursor:pointer;"
                                        ...
                                        <div id="comment_panel" class="comment">
                                            <div class="media">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <a>
                                                            <i onclick="reaction(this.id)" style="cursor:pointer;"
                                                               id="likecomm" class="glyphicon glyphicon-thumbs-up"></i>
                                                        </a>
                                                        <a>
                                                            <i onclick="reaction(this.id)" style="cursor:pointer;"
                                                               id="dislikecomm"
                                                        ...
                                                        <a style="cursor: pointer;" id="reportingComment"
                                                           href="#reportComment" data-toggle="modal" data-whatever="5">
