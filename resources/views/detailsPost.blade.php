                                                    ...
                                                    <div class="media-left">
                                                        <a id="img_container" href="#">
                                                            <img id="post_pic_path" class="media-object photo-profile"
                                                                 src="/{{$post->pic_path}}" width="40" height="40"
                                                                 alt="..." style="border-radius: 50%;">
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
                                                        <a href="#" id="post_u_name" class="anchor-username"><h4
                                                                    class="media-heading">{{$post->auth_name . " " . $post->auth_surname}}</h4>
                                                        </a>
                                                        <a href="#" id="creation_date_{{$post->id_post}}"
                                                           class="anchor-time">{{$post->created_at}}</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                    ...
                                    <section class="post-footer">
                                        ...
                                        <div class="post-footer-option container">
                                            <ul id="option_" class="list-unstyled">
                                                <li><a><i onclick="reaction(this.id)"
                                                          style="cursor:pointer; @if(($post->userlike === 1)) color:blue; @endif "
                                                          id="like_{{$post->id_post}}"
                                                          class="glyphicon glyphicon-thumbs-up"></i></a></li>
                                                <li><a><i onclick="reaction(this.id)"
                                                          style="cursor:pointer; @if($post->userlike === 0) color:red; @endif "
                                                          id="dislike_{{$post->id_post}}"
                                        ...
                                        <div class="post-footer-comment-wrapper">
                                            <div id="comment_panel" class="comment">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <a href="#" id="comment_created_at" class="anchor-time">51
                                                            mins</a>
                                                        <br>
                                                    ...
                                                    <div class="media">
                                                        <div class="media-left">
                                                            <a href="/profile/user/{{$comment->id_author}}">
                                                                <img id="comm_pic_path" src="/{{$comment->pic_path}}"
                                                                     class="media-object photo-profile" src=""
                                                        ...
                                                        <div class="media-body">
                                                            <a href="#" id="comment_author" class="anchor-username"><h4
                                                                        class="media-heading">{{ $comment->auth_name . " " . $comment->auth_surname}}</h4>
                                                            </a>
                                                            <a href="#" id="comment_created_at"
                                                               class="anchor-time">{{ $comment->created_at }}</a>
                                                            <br>
                                                            <span id="comment_content">{{ $comment->content }}</span>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <a><i onclick="reaction(this.id)"
                                                                      style="cursor:pointer; @if($comment->userlike === 1) color:blue; @endif "
                                                                      id="likecomm_{{ $comment->id_comment }}"
                                                                      class="glyphicon glyphicon-thumbs-up"></i></a>
                                                                <a><i onclick="reaction(this.id)"
                                                                      style="cursor:pointer; @if($comment->userlike === 0) color:red; @endif "
                                                                      id="dislikecomm_{{ $comment->id_comment }}"
                                                                      class="glyphicon glyphicon-thumbs-down"></i></a>
                                                                <a style="cursor: pointer;" id="reportingComment"
                                                                   href="#reportComment" data-toggle="modal"
                                                                   data-whatever="5"><i
                                            ...
                                            <div class="comment-form">
                                                <textarea onkeypress="newComment(event, this.id)"
                                                          id="comment_insert_{{ $post->id_post }}"
                                                          class="form-control form-rounded"
                                                          placeholder="Add a comment.." type="text"></textarea>
                                            </div>
                                        </div>
                                    </section>
                                </div>
        ...
        function newComment(e, id) {
            ...
            if (e.keyCode === 13) {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    data: {
                        content: $("#comment_insert_" + id.split("_")[2]).val(),
                        id_post: id.split("_")[2],
                        _token: '{{csrf_token()}}'
                    },
